...
import 'package:brijraj/utils/alert_message_utils.dart';
      ...
      children: [
        GestureDetector(
          onTap: () {
            ...
            print(_controller.dateController.text);
            print(_controller.selectedCustomerName.value);
            print(_controller.selectedCustomerCode.value);
            print(_controller.selectedVehicleNo.value);
            print(_controller.selectedVehicleCode.value);
            print(_controller.items);
          },
          child: Scaffold(
